...
const OTPLogin: React.FC<LoginProps> = ({
  setIsLoginOpen,
  setIsLogComponent,
}) => {
  ...
  return (
    <>
      {/* Branding Header */}
      <div className="relative bg-green-600 p-10 text-center text-white">
        <button
      ...
      <div className="p-8 md:p-10">
        {step === 1 ? (
          ...
          <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <Link to={`/auth/${AuthRouteType.LOGIN}`}>Login with Password</Link>
            {/* <button
              onClick={() => setIsLogComponent(true)}
              className="w-full bg-green-600 hover:bg-green-700 text-white font-black py-4 rounded-2xl shadow-lg shadow-green-100 transition-all active:scale-95 uppercase tracking-widest text-sm"
            >
